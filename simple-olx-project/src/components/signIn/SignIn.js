...
export default function SignIn ({showProducts}){
    ...
    if(name === "" && email === ""&& password === ""){
        ...
        for(let a = 1; a <= 20; a++) {
          ...
          if(usr) {
              ...
              console.log(myCk)
              if(myCk.email === email && myCk.name === name && myCk.password === password) {
                bool1 = true;
            }
    ...
    return (<div>
        ...
        {checkAccount1? <p style={{color:"#f00" ,fontSize:20,fontWeight:600}}>Please fill out the input fields</p> : checkAccount2 ? <p style={{color:"#2e8024",fontSize:20,fontWeight:600}}>Loged in Successfully</p> : checkAccount3 ? <p style={{color:"#f00",fontSize:20,fontWeight:700}}>This Account is not exist</p> :"" }
